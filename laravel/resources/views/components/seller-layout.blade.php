    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside data-tour="seller-sidebar" :class="sidebarOpen ? 'w-64' : 'w-[80px]'" class="flex-shrink-0 bg-violet-950 border-r border-violet-900 transition-all duration-300 ease-in-out z-20 flex flex-col shadow-2xl">
            ...
            <div class="h-20 flex items-center justify-between px-5 border-b border-violet-900/50 transition-all duration-300">
                <div class="flex items-center space-x-3 overflow-hidden" x-show="sidebarOpen" x-transition:enter="transition ease-out duration-300 delay-100" x-transition:enter-start="opacity-0 translate-x-[-20px]" x-transition:enter-end="opacity-100 translate-x-0">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] font-semibold tracking-widest uppercase text-violet-300">Seller Portal</p>
                    </div>
                </div>
                <!-- Toggle Button -->
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden py-6 px-3 space-y-2">
                ...
                <p x-show="sidebarOpen" x-transition.opacity class="px-4 text-xs font-semibold text-violet-300/70 uppercase tracking-wider mb-2 mt-4 first:mt-0">Store</p>

                <!-- Dashboard -->
                <a href="{{ route('seller.dashboard') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.dashboard') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('seller.dashboard') ? 'text-violet-900' : 'text-violet-400 group-hover:text-white transition-colors duration-200' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Products -->
                <a href="{{ route('seller.products.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.products.*') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('seller.products.*') ? 'text-violet-900' : 'text-violet-400 group-hover:text-white transition-colors duration-200' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Orders -->
                <a href="{{ route('seller.orders.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.orders.*') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('seller.orders.*') ? 'text-violet-900' : 'text-violet-400 group-hover:text-white transition-colors duration-200' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div x-show="!sidebarOpen" class="absolute left-14 bg-white text-violet-950 font-semibold shadow-xl border border-violet-100 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50">Orders</div>
                </a>

                <p x-show="sidebarOpen" x-transition.opacity class="px-4 text-xs font-semibold text-violet-300/70 uppercase tracking-wider mb-2 mt-6">Insights & Support</p>

                <!-- Inquiries -->
                <a href="{{ route('seller.inquiries.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.inquiries.*') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('seller.inquiries.*') ? 'text-violet-900' : 'text-violet-400 group-hover:text-white transition-colors duration-200' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('seller.feedback.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.feedback.*') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <div x-show="!sidebarOpen" class="absolute left-14 bg-white text-violet-950 font-semibold shadow-xl border border-violet-100 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50">Feedback</div>
                </a>
                ...
                <a href="{{ route('seller.reports.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative {{ request()->routeIs('seller.reports.*') ? 'bg-white text-violet-950 shadow-lg font-bold' : 'text-violet-200 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <div x-show="!sidebarOpen" class="absolute left-14 bg-white text-violet-950 font-semibold shadow-xl border border-violet-100 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50">Sales Reports</div>
                </a>
            </nav>
            
            <div class="px-3 py-4 border-t border-violet-900/50 transition-all duration-300">
                <form method="POST" action="{{ route('seller.logout') }}">
                    @csrf
                    <button type="submit" class="w-full flex items-center px-3 py-3 rounded-xl transition-all duration-200 group relative text-violet-200 hover:bg-red-500/20 hover:text-red-400" :class="!sidebarOpen ? 'justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0 text-violet-400 group-hover:text-red-400 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div x-show="!sidebarOpen" class="absolute left-14 bg-white text-violet-950 font-semibold shadow-xl border border-violet-100 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50">Log Out</div>
                    </button>
                </form>
            </div>
        </aside>
