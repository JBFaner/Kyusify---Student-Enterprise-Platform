            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-[#13111C] p-6 sm:p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] border border-gray-100 dark:border-gray-800/60">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Business Description</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                            <div>
                                <label for="contact_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Business Support Email</label>
                                <div class="relative">
                                    ...
                                    <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $enterprise->contact_email) }}" placeholder="support@yourstore.com" class="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-[#13111C] border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 text-gray-900 dark:text-white transition-shadow @error('contact_email') border-red-500 @enderror">
                                </div>
                                @error('contact_email')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $enterprise->contact_phone) }}" placeholder="09XX XXX XXXX" class="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-[#13111C] border border-gray-200 dark:border-gray-800 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500 text-gray-900 dark:text-white transition-shadow @error('contact_phone') border-red-500 @enderror">
                                </div>
                                @error('contact_phone')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                ...
                <div class="bg-white dark:bg-[#13111C] p-6 sm:p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] border border-gray-100 dark:border-gray-800/60">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Student Verification</h3>
                    ...
                    <div>
                        <div class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-xl overflow-hidden relative group">
                            ...
                            <div class="space-y-2 text-center relative z-10">
                                <svg class="mx-auto h-12 w-12 text-gray-400 group-hover:text-violet-500 transition-colors" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                                    <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <div class="flex text-sm text-gray-600 dark:text-gray-400 justify-center">
                                    <label for="document" class="relative cursor-pointer bg-white dark:bg-[#13111C] rounded-md font-medium text-violet-600 dark:text-violet-400 hover:text-violet-500 focus-within:outline-none px-1">
                                        <span>Upload a file</span>
                                        <input id="document" name="document" type="file" class="sr-only" accept=".pdf,.jpg,.jpeg,.png">
                                    </label>
                                    <p class="pl-1">or drag and drop</p>
                                </div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 font-semibold tracking-wider uppercase pt-1">
